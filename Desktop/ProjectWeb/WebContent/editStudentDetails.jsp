...
<legend align="left" width="50%"><b><font size="4" color="RED" face="Courier New">EDIT STUDENT DETAILS</font></b></legend>
...
<tr>
<td><font face="courier" size="2" color="gray"><input type="button"  value="Submit" onClick="validateForm()"/></font></td>
</tr>
<tr>
<td><font face="courier" size="2" color="gray"><a href="searchAllStudent.jsp"><input type="button" value="back" /></a></font></td>
</tr>
<%
}
}

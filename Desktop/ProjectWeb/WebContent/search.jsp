...
<li><a href="school.jsp">SCHOOLS</a></li>
...
<hr>
<div align ="center">
  <font size="3" face="Courier", color ="red">The following search found...</font>
<table>
<%
String quest =request.getParameter("query");
...
{
	%>
	<tr><td><a href="<%=rs.getString("link") %>" > <%=str%></a> </td>
	<%
}
	}

...
width: 1400px; /*Width of Carousel Viewer itself*/
...
width: 1350px; /*Width of each panel holding each content. If removed, widths should be individually defined on each content DIV then. */
}
...
stepcarousel.setup({
	...
	defaultbuttons: {enable: true, moveby: 1, leftnav: ['arrowl.gif', 40, 230], rightnav: ['arrowr.gif', -80, 230]},
...
<tr>
<td></td>
<td> <h2>School of Drama</h2> </td><td></td>
</tr>
<tr>
<td>
</td>
...
<div class="panel">
<img src="img/arch1.JPG" height="500px" width="1350px" />
</div>

<div class="panel">
<img src="img/arch2.JPG" height="500px" width="1350px" />
</div>

<div class="panel">
<img src="img/arch3.JPG" height="500px" width="1350px" />
</div>
